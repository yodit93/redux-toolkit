...
# 📖 Redux-toolkit exercise: <a name="about-project"></a>

> Redux-toolkit exercise is a project that is part of the Microverse curriculum. The goal of this project is to practice using redux-toolkit to build a simple cart app.
...
``git clone `https://github.com/yodit93/redux-toolkit.git`
...
Feel free to check the [issues page](https://github.com/yodit93/redux-toolkit/issues).
